...
/* ══════════════════════════════════════════════
   ...
   slug (URL)         label visible      category en products[]
══════════════════════════════════════════════ */
const CATEGORY_MAP = {
...
export default function Coleccion() {
  const { categoria } = useParams()   // undefined si es /coleccion
  ...
  /* Título y descripción según contexto */
  ...
  /* Reveal on scroll — se vuelve a ejecutar al cambiar de categoría */
  useEffect(() => {
  ...
  }, [categoria])   // re-corre al cambiar filtro
  ...
  return (
    <>
      ...
      <main style={{ backgroundColor: 'var(--ivory)', minHeight: '100vh' }}>
        ...
        {/* ── Hero de sección ── */}
        <div
          className="px-6 pt-14 pb-10 md:pt-20 md:pb-14"
              ...
              {CHIPS.map(({ label, slug }) => {
                ...
                return (
                  <Link
                    ...
                    onMouseLeave={(e) => {
                      if (!isActive) {
                        e.currentTarget.style.borderColor = 'var(--linen-mid)'
          ...
          <div className="max-w-7xl mx-auto">
            ...
            {filtered.length === 0 ? (
              ...
              <div className="text-center py-20 reveal">
                <svg
                  viewBox="0 0 64 64" fill="none" stroke="currentColor" strokeWidth="1"
                ...
                <p
                  ...
                  style={{ fontSize: '1.4rem', color: 'var(--charcoal)' }}
                >
                ...
                >
                  ...
                  <br />Estamos trabajando para traerte nuevas piezas.
                </p>
